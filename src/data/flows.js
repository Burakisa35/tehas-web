...
export const KOLAY_HIZMET_FLOW = {
  id: 'kolay_hizmet',
  label: 'Kolay Hizmet',
  ico: '🧭',
  fiyatBadge: null,
  steps: [
    // ── Konu seçimi ──────────────────────────────────────────────
    {
      id: 'kolay_hizmet_konu',
      label: 'Konu',
      title: 'Hangi konuda yardım istiyorsunuz?',
      subtitle: 'Teknik bilgi gerekmez — en yakın olanı seçin.',
      type: 'choice',
      required: true,
      options: [
        { value: 'kamera',     label: 'Güvenlik Kamerası',      ico: '📷', sub: 'Kamera kurulumu, izleme, kayıt' },
        { value: 'elektrik',   label: 'Elektrik / Aydınlatma',  ico: '⚡',  sub: 'Arıza, montaj, priz, aydınlatma' },
        { value: 'ag',         label: 'İnternet / Ağ',           ico: '🌐', sub: 'Wi-Fi, modem, kablo, bağlantı' },
        { value: 'uydu',       label: 'TV / Uydu',               ico: '📡', sub: 'Çanak, sinyal, oda ekleme' },
        { value: 'alarm',      label: 'Alarm / Kapı / Diyafon',  ico: '🔔', sub: 'Alarm, zil, kapı açma sistemi' },
        { value: 'apartman',   label: 'Apartman / Site İşi',     ico: '🏢', sub: 'Ortak alan, bina sistemleri' },
        { value: 'emin_degil', label: 'Emin değilim',            ico: '💬', sub: 'Durumu anlatayım, siz yönlendirin' },
      ],
    },

    // ── KAMERA alt adımları ──────────────────────────────────────
    {
      id: 'kolay_kamera_kullanim',
      label: 'Kamera yeri',
      title: 'Kamera nereye kurulacak?',
      subtitle: null,
      type: 'choice',
      required: true,
      condition: (a) => a.kolay_hizmet_konu === 'kamera',
      options: [
        { value: 'ev',          label: 'Ev / Villa için',          ico: '🏠', sub: 'Müstakil ev, villa, yazlık' },
        { value: 'apartman',    label: 'Apartman / Site için',     ico: '🏢', sub: 'Bina girişi, ortak alanlar' },
        { value: 'isyeri',      label: 'İş yeri için',             ico: '🏪', sub: 'Dükkan, ofis, depo, fabrika' },
        { value: 'arazi_bahce', label: 'Arazi / bahçe için',       ico: '🌿', sub: 'Elektrik veya internet olmayan dış alan' },
      ],
    },
    {
      id: 'kolay_kamera_alan_ev',
      label: 'Ev alanı',
      title: 'Hangi alanı izlemek istiyorsunuz?',
      subtitle: null,
      type: 'multi-choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'kamera' && a.kolay_kamera_kullanim === 'ev',
      options: [
        { value: 'kapi_onu',     label: 'Kapı önü',         ico: '🚪' },
        { value: 'kapi_giris',   label: 'Kapı girişi',      ico: '🔑' },
        { value: 'bahce_arac',   label: 'Bahçe / araç',     ico: '🚗' },
    ...
    },
    {
      ...
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'kamera' && a.kolay_kamera_kullanim === 'isyeri',
      options: [
        { value: 'giris',      label: 'Giriş',               ico: '🚪' },
        { value: 'kasa',       label: 'Kasa / yazar kasa',   ico: '💰' },
        { value: 'depo',       label: 'Depo',                ico: '📦' },
    ...
    {
      id: 'kolay_kamera_alan_apartman',
      label: 'Apartman alanı',
      title: 'Hangi ortak alanlar izlenecek?',
      subtitle: null,
      type: 'multi-choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'kamera' && a.kolay_kamera_kullanim === 'apartman',
      options: [
        { value: 'bina_girisi', label: 'Bina girişi',   ico: '🚪' },
        { value: 'otopark',     label: 'Otopark',        ico: '🅿️' },
        { value: 'asansor',     label: 'Asansör',        ico: '🛗' },
    ...
    {
      id: 'kolay_kamera_ihtiyac',
      label: 'Kamera ihtiyacı',
      title: 'Kameradan ne bekliyorsunuz?',
      subtitle: 'Birden fazla seçebilirsiniz.',
      type: 'multi-choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'kamera',
      options: [
        { value: 'telefon_izleme', label: 'Telefondan izleme',    ico: '📱', sub: 'Uzaktan anlık görüntü' },
        { value: 'gecmis_goruntu', label: 'Geçmiş görüntü kaydı', ico: '💾', sub: 'Geriye dönük kayıt' },
        { value: 'gece_goruntu',   label: 'Gece görüntüsü',       ico: '🌙', sub: 'Karanlıkta net görüntü' },
        { value: 'sadece_canli',   label: 'Sadece canlı izleme',  ico: '👁️', sub: 'Kayıt gerekmez' },
      ],
    },

    // ── ELEKTRİK alt adımları ────────────────────────────────────
    {
      id: 'kolay_elektrik_sorun',
      label: 'Elektrik konusu',
      title: 'Elektrikte ne yapmak istiyorsunuz?',
      subtitle: null,
      type: 'choice',
      required: true,
      condition: (a) => a.kolay_hizmet_konu === 'elektrik',
      options: [
        { value: 'priz',           label: 'Priz',                         ico: '🔌', sub: 'Priz arızası veya yeni priz' },
        { value: 'lamba',          label: 'Lamba / Aydınlatma',           ico: '💡', sub: 'Avize, spot, LED, sensörlü lamba' },
        { value: 'sigorta',        label: 'Sigorta atıyor',               ico: '⚡',  sub: 'Sigorta sürekli veya bazen atıyor' },
        { value: 'elektrik_yok',   label: 'Elektrik kesiliyor / gelmiyor', ico: '🔦', sub: 'Tamamen veya kısmen akım yok' },
        { value: 'yeni_hat_cihaz', label: 'Yeni hat / cihaz bağlantısı', ico: '🏗️', sub: 'Klima hattı, ankastre, hat çekme' },
        { value: 'gunes_enerjisi', label: 'Güneş enerjisi sistemi',       ico: '☀️',  sub: 'Solar panel, akü, inverter' },
        { value: 'emin_degil',     label: 'Emin değilim',                 ico: '💬', sub: 'Anlatayım, siz belirleyin' },
      ],
    },
    {
      id: 'kolay_elektrik_priz',
      label: 'Priz konusu',
      title: 'Prizle ilgili ne gerekiyor?',
      subtitle: null,
      type: 'choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'elektrik' && a.kolay_elektrik_sorun === 'priz',
      options: [
        { value: 'priz_arizali',    label: 'Priz çalışmıyor / arızalı', ico: '⚡' },
        { value: 'yeni_priz',       label: 'Yeni priz taktırmak',       ico: '🔌' },
        { value: 'cihaz_icin_priz', label: 'Cihaz için güçlü priz',     ico: '🖥️' },
        { value: 'emin_degil',      label: 'Emin değilim',              ico: '💬' },
      ],
    },
    {
      id: 'kolay_elektrik_lamba',
      label: 'Lamba konusu',
      title: 'Lamba / aydınlatma için ne gerekiyor?',
      subtitle: null,
      type: 'choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'elektrik' && a.kolay_elektrik_sorun === 'lamba',
      options: [
        { value: 'avize',        label: 'Avize takma / değişim',    ico: '🔆' },
        { value: 'sensorlu',     label: 'Sensörlü lamba',           ico: '👁️' },
        { value: 'spot_led',     label: 'Spot / LED kurulumu',      ico: '💡' },
        { value: 'dis_mekan',    label: 'Dış mekan aydınlatma',     ico: '🌿' },
        { value: 'emin_degil',   label: 'Emin değilim',             ico: '💬' },
      ],
    },
    {
      id: 'kolay_elektrik_sigorta',
      label: 'Sigorta durumu',
      title: 'Sigorta ne zaman atıyor?',
      subtitle: null,
      type: 'choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'elektrik' && a.kolay_elektrik_sorun === 'sigorta',
      options: [
        { value: 'surekli',         label: 'Sürekli atıyor',              ico: '⚠️' },
        { value: 'bazen',           label: 'Bazen / ara sıra atıyor',     ico: '❓' },
        { value: 'cihaz_calisinca', label: 'Bir cihaz çalışınca atıyor',  ico: '🖥️' },
        { value: 'koku_isinma',     label: 'Koku veya ısınma var',        ico: '🌡️' },
        { value: 'emin_degil',      label: 'Emin değilim',                ico: '💬' },
      ],
    },
    {
      id: 'kolay_elektrik_gunes',
      label: 'Güneş enerjisi konusu',
      title: 'Güneş enerjisi sisteminde ne gerekiyor?',
      subtitle: null,
      type: 'choice',
      required: false,
      skipLabel: 'Emin değilim',
      condition: (a) => a.kolay_hizmet_konu === 'elektrik' && a.kolay_elektrik_sorun === 'gunes_enerjisi',
      options: [
        { value: 'sistem_calismiyor',    label: 'Sistem çalışmıyor / arıza', ico: '🔧' },
        { value: 'aku_cabuk_bitiyor',    label: 'Akü çabuk bitiyor',         ico: '🔋' },
        { value: 'cihaz_calistirmak',    label: 'Cihaz çalıştırmak istiyorum', ico: '🖥️' },
        { value: 'uygulama_izleme',      label: 'Uygulama / izleme sorunu',  ico: '📱' },
        { value: 'emin_degil',           label: 'Emin değilim',              ico: '💬' },
      ],
    },
    {
      id: 'kolay_elektrik_yer',
      label: 'Uygulama yeri',
      title: 'Nerede uygulanacak?',
      subtitle: null,
      type: 'choice',
      ...
      condition: (a) => a.kolay_hizmet_konu === 'elektrik',
      options: [
        { value: 'ev',     label: 'Ev / Daire',        ico: '🏠' },
        { value: 'isyeri', label: 'İş yeri',           ico: '🏪' },
        { value: 'bina',   label: 'Bina / Ortak alan', ico: '🏢' },
      ],
    },

    // ── AĞ / İNTERNET alt adımları ──────────────────────────────
    {
      id: 'kolay_ag_sorun',
      label: 'İnternet konusu',
      title: 'İnternet / Ağ konusunda ne gerekiyor?',
      subtitle: null,
      type: 'choice',
      required: true,
      condition: (a) => a.kolay_hizmet_konu === 'ag',
      options: [
        { value: 'wifi_cekmiyor',    label: 'Wi-Fi çekmiyor / zayıf',     ico: '📶', sub: 'Sinyal problemi, ölü bölge' },
        { value: 'internet_kablosu', label: 'İnternet kablosu çekme',     ico: '🔌', sub: 'Odalar arası ethernet' },
        { value: 'modem_router',     label: 'Modem / router kurulumu',    ico: '🌐', sub: 'Yeni cihaz kurma veya değiştirme' },
        { value: 'kamera_interneti', label: 'Kamera için internet',       ico: '📷', sub: 'Kameraya ağ bağlantısı' },
        { value: 'isyeri_agi',       label: 'İş yeri ağ altyapısı',      ico: '🏪', sub: 'Switch, access point, pano' },
        { value: 'emin_degil',       label: 'Emin değilim',              ico: '💬', sub: 'Anlatayım, siz yönlendirin' },
      ],
    },
    {
      id: 'kolay_ag_yer',
      label: 'Ağ yeri',
      title: 'Nerede ağ kurulacak / sorun var?',
      subtitle: null,
      type: 'choice',
      required: false,
      skipLabel: 'Emin değilim',
      ...
      options: [
        { value: 'ev',        label: 'Ev / Daire',        ico: '🏠' },
        { value: 'isyeri',    label: 'İş yeri',           ico: '🏪' },
        { value: 'apartman',  label: 'Apartman / Bina',   ico: '🏢' },
        { value: 'depo',      label: 'Depo / Atölye',     ico: '📦' },
        { value: 'dis_alan',  label: 'Dış alan',          ico: '🌿' },
        { value: 'emin_degil', label: 'Emin değilim',     ico: '💬' },
      ],
    },

    // ── UYDU / TV alt adımları ───────────────────────────────────
    {
      id: 'kolay_uydu_sorun',
      label: 'Uydu konusu',
      title: 'TV / Uydu konusunda ne gerekiyor?',
      subtitle: null,
      type: 'choice',
      required: true,
      condition: (a) => a.kolay_hizmet_konu === 'uydu',
      options: [
        { value: 'yeni_canak_anten', label: 'Yeni çanak / anten kurulumu', ico: '📡', sub: 'İlk kurulum, yeni abonelik' },
        { value: 'sinyal_yok',       label: 'Sinyal yok / zayıf',          ico: '📺', sub: 'Yayın gelmiyor, pikselleşme' },
        { value: 'kanal_yok',        label: 'Kanal gelmiyor',              ico: '📻', sub: 'Belirli kanallar görünmüyor' },
        { value: 'merkezi_sistem',   label: 'Merkezi sistem',              ico: '🏢', sub: 'Apartman / otel merkezi uydu' },
        { value: 'tv_baglanti',      label: 'TV bağlantısı / oda ekleme', ico: '🔌', sub: 'Yeni odaya TV bağlama' },
        { value: 'emin_degil',       label: 'Emin değilim',               ico: '💬', sub: 'Anlatayım, siz yönlendirin' },
      ],
    },

    // ── ALARM / DİYAFON alt adımları ────────────────────────────
    {
      id: 'kolay_alarm_tur',
      label: 'Alarm / Kapı türü',
      title: 'Hangi sistem gerekiyor?',
      subtitle: null,
      type: 'choice',
      required: true,
      condition: (a) => a.kolay_hizmet_konu === 'alarm',
      options: [
        { value: 'alarm_sistemi',  label: 'Alarm sistemi',           ico: '🔔', sub: 'Hırsız alarmı, hareket sensörü' },
        { value: 'kamera_alarm',   label: 'Kamera + Alarm birlikte', ico: '📷', sub: 'Entegre güvenlik sistemi' },
        { value: 'diyafon',        label: 'Diyafon / görüntülü zil', ico: '📟', sub: 'Kapı zili, görüntülü diyafon' },
        { value: 'kapi_zili',      label: 'Kapı zili',               ico: '🔔', sub: 'Basit zil veya değişim' },
        { value: 'kartli_gecis',   label: 'Kartlı / şifreli geçiş', ico: '💳', sub: 'Kapı açma, bina girişi' },
        { value: 'emin_degil',     label: 'Emin değilim',            ico: '💬', sub: 'Anlatayım, siz yönlendirin' },
      ],
    },

    // ── APARTMAN / SİTE alt adımları ────────────────────────────
    {
      id: 'kolay_apartman_konu',
      label: 'Apartman konusu',
      title: 'Ne tür bir işle ilgili?',
      subtitle: null,
      type: 'choice',
      required: true,
      condition: (a) => a.kolay_hizmet_konu === 'apartman',
      options: [
        { value: 'elektrik_arizasi',  label: 'Elektrik arızası',          ico: '⚡',  sub: 'Ortak alan elektrik sorunu' },
        { value: 'kamera_guvenlik',   label: 'Güvenlik kamerası',         ico: '📷', sub: 'Bina kamera sistemi' },
        { value: 'uydu_merkezi',      label: 'Uydu / merkezi anten',      ico: '📡', sub: 'Merkezi uydu veya anten sistemi' },
        { value: 'aydinlatma_sensor', label: 'Aydınlatma / sensör',       ico: '💡', sub: 'Merdiven, otopark aydınlatma' },
        { value: 'periyodik_bakim',   label: 'Periyodik bakım',           ico: '🔧', sub: 'Düzenli bakım anlaşması' },
        { value: 'emin_degil',        label: 'Emin değilim',              ico: '💬', sub: 'Anlatayım, siz yönlendirin' },
      ],
    },
    {
      id: 'kolay_apartman_basvuran',
      label: 'Başvuran',
      title: 'Sizi nasıl tanımlarsınız?',
      subtitle: null,
      type: 'choice',
      required: false,
      skipLabel: 'Atla',
      condition: (a) => a.kolay_hizmet_konu === 'apartman',
      options: [
        { value: 'yonetici',      label: 'Site / Bina yöneticisi', ico: '🏢' },
        { value: 'kat_maliki',    label: 'Kat maliki',             ico: '🔑' },
        { value: 'kiraci',        label: 'Kiracı',                 ico: '📋' },
        { value: 'site_gorevlisi', label: 'Site görevlisi',        ico: '👷' },
        { value: 'emin_degil',    label: 'Emin değilim',           ico: '💬' },
      ],
    },
    ...
    // ── EMİN DEĞİLİM adımı ──────────────────────────────────────
    {
      id: 'kolay_aciklama',
      label: 'Açıklama',
      title: 'Durumu kısaca anlatın',
      subtitle: 'Bildiklerinizi yazın — teknik detay gerekmez.',
      type: 'textarea',
      required: false,
      skipLabel: 'Geç',
      condition: (a) => a.kolay_hizmet_konu === 'emin_degil',
    },
...
export const FLOWS = {
  ...
  solar:        SOLAR_FLOW,
  kolay_hizmet: KOLAY_HIZMET_FLOW,
};
