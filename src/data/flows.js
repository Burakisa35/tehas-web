...
export const KOLAY_HIZMET_FLOW = {
  ...
  steps: [
    ...
    // ── ELEKTRİK alt adımları ────────────────────────────────────
    {
      ...
      options: [
        { value: 'ariza',    label: 'Arıza / Kesinti',        ico: '⚡',  sub: 'Sigorta atıyor, akım kesildi' },
        { value: 'montaj',   label: 'Montaj / Değişim',       ico: '🔧', sub: 'Priz, lamba, anahtar, avize' },
        { value: 'tesisat',  label: 'Hat / Tesisat',          ico: '🏗️', sub: 'Yeni hat, klima hattı, kablo' },
        { value: 'pano',     label: 'Pano / Sigorta',         ico: '🗄️', sub: 'Pano değişimi, kompanzasyon' },
        { value: 'dis_alan', label: 'Dış alan / Bahçe',       ico: '🌿', sub: 'Bahçe aydınlatma, dış priz' },
        { value: 'diger',    label: 'Emin değilim',           ico: '💬', sub: 'Anlatayım, siz belirleyin' },
      ],
    },
    {
    ...
    // ── AĞ / İNTERNET alt adımları ──────────────────────────────
    {
      ...
      options: [
        { value: 'yeni_kurulum', label: 'Yeni kurulum',             ico: '🌐', sub: 'Modem, switch, kablo döşeme' },
        { value: 'wifi_zayif',   label: 'Wi-Fi zayıf / kesiliyor',  ico: '📶', sub: 'Sinyal problemi, mesh çözüm' },
        { value: 'kablo',        label: 'Kablo çekme',              ico: '🔌', sub: 'Oda/kat arası ethernet' },
        { value: 'ag_pano',      label: 'Pano / ağ altyapısı',      ico: '🗄️', sub: 'Switch, ağ panosu, yapılandırma' },
    ...
    // ── UYDU / TV alt adımları ───────────────────────────────────
    {
      ...
      options: [
        { value: 'yeni_canak',  label: 'Yeni çanak kurulumu',  ico: '📡', sub: 'İlk kurulum, yeni abonelik' },
        { value: 'sinyal_yok',  label: 'Sinyal yok / zayıf',   ico: '📺', sub: 'Yayın gelmiyor, pikselleşme' },
        { value: 'oda_ekleme',  label: 'Yeni oda bağlantısı',  ico: '🔌', sub: 'Başka odaya TV bağlama' },
        { value: 'merkezi',     label: 'Merkezi sistem',        ico: '🏢', sub: 'Apartman / otel merkezi uydu' },
        { value: 'emin_degil',  label: 'Emin değilim',         ico: '💬', sub: 'Anlatayım, siz yönlendirin' },
      ],
    },
    ...
    // ── ALARM / DİYAFON alt adımları ────────────────────────────
    {
      ...
      options: [
        { value: 'alarm',        label: 'Alarm sistemi',           ico: '🔔', sub: 'Hırsız alarmı, hareket sensörü' },
        { value: 'diyafon',      label: 'Diyafon / Zil',          ico: '📟', sub: 'Kapı zili, görüntülü diyafon' },
    ...
    {
      id: 'kolay_apartman_sistem',
      label: 'Bina sistemi',
      title: 'Hangi bina sistemiyle ilgili?',
      subtitle: 'Birden fazla seçebilirsiniz.',
      type: 'multi-choice',
      required: false,
      skipLabel: 'Emin değilim',
      ...
      options: [
        { value: 'kamera',   label: 'Güvenlik Kamerası', ico: '📷' },
        { value: 'diyafon',  label: 'Diyafon / Zil',     ico: '📟' },
        { value: 'elektrik', label: 'Elektrik / Pano',   ico: '⚡' },
        { value: 'kapi',     label: 'Kapı / Geçiş',      ico: '🚪' },
        { value: 'ag',       label: 'İnternet / Ağ',     ico: '🌐' },
      ],
    },
    {
      id: 'kolay_apartman_sifat',
      label: 'Başvuran',
      ...
      options: [
        ...
        { value: 'sahip',    label: 'Daire sahibi',           ico: '🔑' },
        { value: 'kiralik',  label: 'Kiracı',                 ico: '📋' },
      ],
    },
